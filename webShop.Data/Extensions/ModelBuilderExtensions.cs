...
namespace webShopSolution.Data.Extensions
{
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AppConfig>().HasData(
                new AppConfig() { Key="HomeTitle", Value ="This is home page of webShopSolution"},
                new AppConfig() { Key="HomeKeyWord", Value ="This is keyword of webShopSolution"},
                new AppConfig() { Key="HomeDescription", Value ="This is description of webShopSolution"}
                );
